...
<head>
    ...
    <title><?= $titulo ?? 'Nueva Contraseña - Cycsa' ?></title>
...
<body>
    ...
    <div class="login-wrapper">
        <div class="login-contenedor">
            ...
            <div class="brand-title">Ingresar Código</div>
            <span class="brand-subtitle">CYCSA ERP</span>
            ...
            <form action="" method="POST">
                <div class="grupo-input">
                    ...
                    <div class="input-wrapper">
                        <input type="email" id="email" name="email" required value="<?= htmlspecialchars($email ?? '', ENT_QUOTES, 'UTF-8') ?>" placeholder="ejemplo@cycsa.com">
                        <i class="fa-solid fa-envelope"></i>
                    </div>
                </div>

                <div class="grupo-input">
                    <label for="codigo">Código de Seguridad (6 dígitos)</label>
                    <div class="input-wrapper">
                        <input type="text" id="codigo" name="codigo" required class="input-codigo" maxlength="6" autocomplete="off" placeholder="000000">
                    </div>
                </div>
            ...
            <div class="enlaces-retorno">
                <a href="/Cycsa/publico/recuperar-password"><i class="fa-solid fa-rotate-left"></i> Solicitar otro código</a>
                <a href="/Cycsa/publico/login">Iniciar Sesión <i class="fa-solid fa-arrow-right"></i></a>
            </div>
