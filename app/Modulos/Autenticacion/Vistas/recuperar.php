...
<head>
    ...
    <title><?= $titulo ?? 'Recuperar Contraseña - Cycsa' ?></title>
...
<body>
    ...
    <div class="login-wrapper">
        <div class="login-contenedor">
            ...
            <div class="brand-title">Restablecer Clave</div>
            <span class="brand-subtitle">CYCSA ERP</span>
            
            <p class="descripcion">
                Ingresa tu dirección de correo electrónico y te enviaremos un código de seguridad para restablecer tu contraseña.
            </p>
            ...
            <div class="enlaces-retorno">
                <a href="/Cycsa/publico/login"><i class="fa-solid fa-arrow-left"></i> Volver al inicio de sesión</a>
            </div>
