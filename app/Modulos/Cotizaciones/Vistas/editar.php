    ...
    <div class="seccion-form">
        ...
        <div class="grid-3">
            <div class="form-group">
                ...
                <select name="condicion_pago" class="form-control" required>
                    ...
                    <?php foreach ($condiciones_pago as $item): ?>
                        <option value="<?= htmlspecialchars($item['valor'], ENT_QUOTES, 'UTF-8') ?>" <?= isset($cotizacion['condicion_pago']) && $cotizacion['condicion_pago'] === $item['valor'] ? 'selected' : '' ?>><?= htmlspecialchars($item['valor'], ENT_QUOTES, 'UTF-8') ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="tiempo_entrega" class="form-control" value="<?= htmlspecialchars($cotizacion['tiempo_entrega'] ?? '', ENT_QUOTES, 'UTF-8') ?>" required placeholder="Ej: 5 a 7 días hábiles" list="tiempos-entrega-datalist">
            ...
            <div class="form-group">
                ...
                <input type="text" name="vigencia_oferta" class="form-control" value="<?= htmlspecialchars($cotizacion['vigencia_oferta'] ?? '15 días calendario', ENT_QUOTES, 'UTF-8') ?>" required placeholder="Ej: 15 días calendario" list="vigencias-oferta-datalist">
