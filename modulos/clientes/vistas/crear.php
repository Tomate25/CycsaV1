...
<div style="max-width: 1000px; margin: 0 auto 20px auto; display: flex; justify-content: space-between; align-items: center;">
    <div>
        ...
        <h2 style="margin: 5px 0 0 0; color: #0f172a; font-size: 22px; font-family: 'Outfit', sans-serif; font-weight: 700;">Registrar Nuevo Cliente</h2>
    </div>
</div>
...
<form action="/Cycsa/publico/clientes/crear" method="POST" style="max-width: 1000px; margin: 0 auto 40px auto;">
    <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($_SESSION['csrf_token'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
    <input type="hidden" name="activo" value="1">

    <!-- SECCIÓN 1: INFORMACIÓN GENERAL -->
    <div class="form-section-card">
        <h3 class="section-title"><i class="fa-solid fa-user-plus"></i> Información General del Cliente</h3>
        <div class="form-grid-3" style="margin-bottom: 20px;">
            <div class="form-group">
                ...
                <select name="tipo_cliente" id="tipo_cliente" required class="form-control" onchange="toggleTipoCliente(this.value)">
                    <option value="Jurídico" <?= ($valores['tipo_cliente'] ?? '') === 'Jurídico' ? 'selected' : '' ?>>Jurídico</option>
                    <option value="Natural" <?= ($valores['tipo_cliente'] ?? '') === 'Natural' ? 'selected' : '' ?>>Natural</option>
                    <option value="Extranjero Jurídico" <?= ($valores['tipo_cliente'] ?? '') === 'Extranjero Jurídico' ? 'selected' : '' ?>>Extranjero Jurídico</option>
                </select>
            </div>
            <div class="form-group">
                <label>Código de Cliente</label>
                <input type="text" name="codigo_cliente" value="<?= htmlspecialchars($valores['codigo_cliente'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: CLI-203">
            </div>
            <div class="form-group">
                <label id="lbl-nombre-cliente">Nombre / Razón Social *</label>
                <input type="text" name="nombre_cliente" required value="<?= htmlspecialchars($valores['nombre_cliente'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: Aceitera El Real S.A.">
            </div>
        </div>
        ...
        <div class="form-grid-3" id="seccion-apellidos" style="display: none; margin-bottom: 20px;">
            <div class="form-group">
                ...
                <input type="text" name="primer_apellido" value="<?= htmlspecialchars($valores['primer_apellido'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: Pérez">
            </div>
            <div class="form-group">
                <label>Segundo Apellido</label>
                <input type="text" name="segundo_apellido" value="<?= htmlspecialchars($valores['segundo_apellido'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: Gómez">
            </div>
            <div class="form-group">
                <label>Sucursal Sede</label>
                <input type="text" name="sucursal_sede" value="<?= htmlspecialchars($valores['sucursal_sede'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: Sede León">
            </div>
        </div>
        ...
        <div class="form-grid-3" style="margin-bottom: 20px;">
            <div class="form-group">
                ...
                <input type="text" name="clasificacion" value="<?= htmlspecialchars($valores['clasificacion'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: VIP, Frecuente, etc.">
            </div>
            <div class="form-group">
                <label>Sub Clasificación</label>
                <input type="text" name="sub_clasificacion" value="<?= htmlspecialchars($valores['sub_clasificacion'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: Corporativo">
            </div>
            <div class="form-group">
                <label>Vendedor</label>
                <input type="text" name="vendedor" value="<?= htmlspecialchars($valores['vendedor'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: CYCSA- FR12-003--Tiana Grillo">
            </div>
        </div>
        ...
        <div class="form-grid-3" style="margin-bottom: 20px;">
            <div class="form-group">
                ...
                <input type="text" name="numero_cedula" value="<?= htmlspecialchars($valores['numero_cedula'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: 001-200590-0012A">
            </div>
            <div class="form-group">
                <label>Número RUC</label>
                <input type="text" name="numero_ruc" value="<?= htmlspecialchars($valores['numero_ruc'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: J0310000000980">
            </div>
            <div class="form-group">
                <label>Contacto Principal</label>
                <input type="text" name="contacto" value="<?= htmlspecialchars($valores['contacto'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: Ing. Milder Gutierrez">
            </div>
        </div>
        ...
        <div class="form-grid-3" style="margin-bottom: 20px;">
            <div class="form-group">
                ...
                <input type="text" name="telefono" value="<?= htmlspecialchars($valores['telefono'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: +505 8888 8888">
            </div>
            <div class="form-group">
                <label>Fax</label>
                <input type="text" name="fax" value="<?= htmlspecialchars($valores['fax'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: 2222-3333">
            </div>
            <div class="form-group">
                <label>Correo Electrónico Principal</label>
                <input type="email" name="email" value="<?= htmlspecialchars($valores['email'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: admin@empresa.com">
            </div>
        </div>
        ...
        <div class="form-grid-2">
            <div class="form-group">
                ...
                <textarea name="direccion" rows="2" class="form-control" placeholder="Dirección exacta del cliente..."><?= htmlspecialchars($valores['direccion'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
            </div>
            <div class="form-group">
                <label>Notas Internas / Observaciones</label>
                <textarea name="notas" rows="2" class="form-control" placeholder="Notas sobre facturación, despacho u observaciones especiales..."><?= htmlspecialchars($valores['notas'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="form-section-card">
        ...
        <div class="form-grid-3" style="margin-bottom: 20px;">
            <div class="form-group">
                ...
                <input type="hidden" name="cuenta_cxc" id="input-cuenta_cxc" value="<?= htmlspecialchars($valores['cuenta_cxc'] ?? '1010201 / CLIENTES NACIONALES', ENT_QUOTES, 'UTF-8') ?>">
                <div class="custom-select-trigger" onclick="abrirBuscadorCuentas('cuenta_cxc')">
                    <span id="label-cuenta_cxc"><?= htmlspecialchars($valores['cuenta_cxc'] ?? '1010201 / CLIENTES NACIONALES', ENT_QUOTES, 'UTF-8') ?></span>
                    <i class="fa-solid fa-chevron-down" style="color: #64748b; font-size: 12px;"></i>
                </div>
            </div>
            <div class="form-group">
                <label>Cuenta por Pagar *</label>
                <input type="hidden" name="cuenta_cxp" id="input-cuenta_cxp" value="<?= htmlspecialchars($valores['cuenta_cxp'] ?? '2010303 / ANTICIPO CLIENTES', ENT_QUOTES, 'UTF-8') ?>">
                <div class="custom-select-trigger" onclick="abrirBuscadorCuentas('cuenta_cxp')">
                    <span id="label-cuenta_cxp"><?= htmlspecialchars($valores['cuenta_cxp'] ?? '2010303 / ANTICIPO CLIENTES', ENT_QUOTES, 'UTF-8') ?></span>
                    <i class="fa-solid fa-chevron-down" style="color: #64748b; font-size: 12px;"></i>
                </div>
            </div>
        ...
        <div class="form-grid-3" style="margin-bottom: 20px;">
            <div class="form-group">
                ...
                <input type="text" name="limite_credito" value="<?= htmlspecialchars($valores['limite_credito'] ?? '0.00', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: 20,000.00">
            </div>
            <div class="form-group">
                <label>Días de Crédito</label>
                <input type="number" name="dias_credito" value="<?= htmlspecialchars($valores['dias_credito'] ?? '0', ENT_QUOTES, 'UTF-8') ?>" class="form-control">
            </div>
            <div class="form-group">
                <label>No. de Facturas Vencidas Permitidas</label>
                <input type="number" name="facturas_vencidas_permitidas" value="<?= htmlspecialchars($valores['facturas_vencidas_permitidas'] ?? '0', ENT_QUOTES, 'UTF-8') ?>" class="form-control">
            </div>
        </div>
        ...
        <div class="form-grid-3" style="margin-bottom: 20px;">
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="porcentaje_descuento" value="<?= htmlspecialchars($valores['porcentaje_descuento'] ?? '0.00', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: 5.00">
            </div>
            <div class="form-group" id="grupo-cuenta-exonerado" style="display: none;">
                <label>Cuenta para Ingresos Exonerados</label>
                <input type="hidden" name="cuenta_ingresos_exonerados" id="input-cuenta_ingresos_exonerados" value="<?= htmlspecialchars($valores['cuenta_ingresos_exonerados'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
                <div class="custom-select-trigger" onclick="abrirBuscadorCuentas('cuenta_ingresos_exonerados')">
                    <span id="label-cuenta_ingresos_exonerados"><?= htmlspecialchars($valores['cuenta_ingresos_exonerados'] ?: '-- Seleccione Cuenta Exonerados --', ENT_QUOTES, 'UTF-8') ?></span>
                    <i class="fa-solid fa-chevron-down" style="color: #64748b; font-size: 12px;"></i>
                </div>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; border-top: 1px solid #f1f5f9; padding-top: 15px;">
            <div class="checkbox-group">
                <input type="checkbox" name="exonerado_impuestos" id="exonerado_impuestos" value="1" <?= ($valores['exonerado_impuestos'] ?? '') == 1 ? 'checked' : '' ?> onchange="toggleExonerado(this.checked)">
                <label for="exonerado_impuestos">Exonerado de Impuestos</label>
            </div>
            <div class="checkbox-group">
                <input type="checkbox" name="exportacion" id="exportacion" value="1" <?= ($valores['exportacion'] ?? '') == 1 ? 'checked' : '' ?>>
                <label for="exportacion">Cliente de Exportación</label>
            </div>
            <div class="checkbox-group">
                <input type="checkbox" name="activar_prorroga_credito" id="activar_prorroga_credito" value="1" <?= ($valores['activar_prorroga_credito'] ?? '') == 1 ? 'checked' : '' ?>>
                <label for="activar_prorroga_credito">Activar Prórroga de Crédito</label>
            </div>
            <div class="checkbox-group">
                <input type="checkbox" name="descuento_automatico" id="descuento_automatico" value="1" <?= ($valores['descuento_automatico'] ?? '') == 1 ? 'checked' : '' ?>>
                <label for="descuento_automatico">Descuento Automático</label>
            </div>
            <div class="checkbox-group">
                <input type="checkbox" name="predeterminado_pos" id="predeterminado_pos" value="1" <?= ($valores['predeterminado_pos'] ?? '') == 1 ? 'checked' : '' ?>>
                <label for="predeterminado_pos">Predeterminado POS</label>
            </div>
            <div class="checkbox-group">
                <input type="checkbox" name="facturacion_correo" id="facturacion_correo" value="1" <?= ($valores['facturacion_correo'] ?? '') == 1 ? 'checked' : '' ?>>
    ...
    <div class="form-section-card">
        ...
        <div class="form-grid-2" style="margin-bottom: 20px;">
            <div class="form-group">
                ...
                <input type="text" name="contacto_nombre" value="<?= htmlspecialchars($valores['contacto_nombre'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: Ana Teresa">
            </div>
            <div class="form-group">
                <label>Apellido(s) del Contacto</label>
                <input type="text" name="contacto_apellido" value="<?= htmlspecialchars($valores['contacto_apellido'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: Ríos Mejía">
            </div>
        </div>
        <div class="form-grid-2">
            <div class="form-group">
                <label>Cargo del Contacto</label>
                <input type="text" name="contacto_cargo" value="<?= htmlspecialchars($valores['contacto_cargo'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: Gerente Administrativo">
            </div>
            <div class="form-group">
                <label>Correo Electrónico de Contacto</label>
                <input type="email" name="contacto_correo" value="<?= htmlspecialchars($valores['contacto_correo'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="form-control" placeholder="Ej: admon@empresa.com">
            </div>
        </div>
    </div>
